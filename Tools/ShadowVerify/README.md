...
# 🚀 What's New in Shadow Verify v2.0

Shadow Verify is the next evolution of the original MDE Test Framework.

### New in v2.0

✅ Shadow Suite branding and user experience

✅ Enhanced validation dashboard

✅ Validation scorecards (Pass / Verify / Fail)

✅ Interactive HTML reporting

✅ Guided Testing Experiences

✅ ASR validation workflows

✅ Pop-out analyst guidance blades

✅ Improved Defender portal verification guidance

✅ Purple/black Shadow Suite reporting theme

✅ Expanded reporting and analyst-focused validation

### Preserved from the MDE Test Framework
